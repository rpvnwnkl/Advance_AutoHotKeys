...
createEntity(prefix, firstName, middleName, lastName, suffix, proSuffix, recYear, recSchool, recType, recStatus, comment)
{
    ...
    moveTo(dbName)
    dupeExists := waitForWindow("Duplicate Entities", 100)
...
create_new_hon_alum_record()
{
    ...
    honAlum := "Y"
    localAlum := "Y"
    addDegree(instID, degCode, schoolCode, campusCode, majorCode, classYear, gradLevel, gradType, honAlum, localAlum)
